...
const publicDocs = [
  ...
  ["02_data-pipeline.md", path.join("guide", "architecture", "data-pipeline.md")],
  ["03_RPC-contract.md", path.join("guide", "architecture", "rpc-contract.md")],
  ["04_server-state.md", path.join("guide", "architecture", "server-state.md")],
  ["05_MCP-integration.md", path.join("guide", "architecture", "mcp-integration.md")],
  [path.join("dev", "quick-start.md"), path.join("guide", "dev", "quick-start.md")],
  [path.join("dev", "setup.md"), path.join("guide", "dev", "setup.md")],
  [path.join("dev", "arch.md"), path.join("guide", "architecture", "engineering-arch.md")],
  ...
  [path.join("dev", "site.md"), path.join("guide", "dev", "site-maintenance.md")],
  [path.join("use", "install.md"), path.join("guide", "use", "install.md")],
  [path.join("use", "config.md"), path.join("guide", "use", "config.md")],
